...
typedef struct
{
	volatile uint32_t FEIF0 :1; // Bit 0  - FIFO error flag Stream0
	volatile uint32_t RESERVED0 :1; // Bit 1  - Reserved
	volatile uint32_t DMEIF0 :1; // Bit 2  - Direct mode error flag Stream0
	volatile uint32_t TEIF0 :1; // Bit 3  - Transfer error flag Stream0
	volatile uint32_t HTIF0 :1; // Bit 4  - Half transfer flag Stream0
	volatile uint32_t TCIF0 :1; // Bit 5  - Transfer complete flag Stream0
	volatile uint32_t RESERVED1 :2; // Bits 6–7 Reserved
	volatile uint32_t FEIF1 :1; // Bit 8  - FIFO error flag Stream1
	volatile uint32_t RESERVED2 :1; // Bit 9  - Reserved
	volatile uint32_t DMEIF1 :1; // Bit 10 - Direct mode error flag Stream1
	volatile uint32_t TEIF1 :1; // Bit 11 - Transfer error flag Stream1
	volatile uint32_t HTIF1 :1; // Bit 12 - Half transfer flag Stream1
	volatile uint32_t TCIF1 :1; // Bit 13 - Transfer complete flag Stream1
	volatile uint32_t RESERVED3 :2; // Bits 14–15 Reserved
	volatile uint32_t FEIF2 :1; // Bit 16 - FIFO error flag Stream2
	volatile uint32_t RESERVED4 :1; // Bit 17 - Reserved
	volatile uint32_t DMEIF2 :1; // Bit 18 - Direct mode error flag Stream2
	volatile uint32_t TEIF2 :1; // Bit 19 - Transfer error flag Stream2
	volatile uint32_t HTIF2 :1; // Bit 20 - Half transfer flag Stream2
	volatile uint32_t TCIF2 :1; // Bit 21 - Transfer complete flag Stream2
	volatile uint32_t RESERVED5 :2; // Bits 22–23 Reserved
	volatile uint32_t FEIF3 :1; // Bit 24 - FIFO error flag Stream3
	volatile uint32_t RESERVED6 :1; // Bit 25 - Reserved
	volatile uint32_t DMEIF3 :1; // Bit 26 - Direct mode error flag Stream3
	volatile uint32_t TEIF3 :1; // Bit 27 - Transfer error flag Stream3
	volatile uint32_t HTIF3 :1; // Bit 28 - Half transfer flag Stream3
	volatile uint32_t TCIF3 :1; // Bit 29 - Transfer complete flag Stream3
	volatile uint32_t RESERVED7 :2; // Bits 30–31 Reserved
} DMA_LISR_t;
